                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context).pushNamed(
                            postDetailWidget,
                            arguments: postDataList[item],
                          );
                        },
                        child: PostModel(
                          title: postDataList[0][0]["title"]!,
                          price: postDataList[0][1]["price"]!,
                          deal: postDataList[0][2]["deal"]!,
                          place: postDataList[0][3]["place"]!,
                          postedTime: postDataList[0][4]["postedTime"]!,
                          imageURL: postDataList[0][5]["imageURL"]!,
                        ),
                      );
                    },
